...
class SysInfo(models.Model):
    mac_id = models.PositiveIntegerField(default=0, unique=True) #it is actually the id of user
...
class RAM(models.Model):
    mac_id = models.ForeignKey(SysInfo, on_delete=models.CASCADE, default=0, to_field='mac_id')
